...
def hi_art(M,label,rho,save_path_root):
    '''
...
# Clustering process
    ...
    for n in range(1,row):
        ...
        temp[0,:] = rho_0[0, :]  # to recover the rho of winner cluster in the later computation
        ...
        if winner == -1: #indicates no cluster passes the vigilance parameter - the rho
            ...
            L[0, winner] += 1
            Assign[0,n] = winner
            rho_0[0,winner] = (1 + sigma) * temp[0,winner]
